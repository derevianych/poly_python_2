# библиотека Pandas
# Надстройка над numpy
# Series - "обертка" для массивов, где индексом может быть все, что угодно
# DataFrame - массив из Series
# Index
...
print(data_dict1.add(data_dict2))
